...
<!--
        <div class="info-card">
          ...
          <div class="info-content">
            ...
            <span class="info-value"><a href="https://velog.io/@tlqhrm" target="_blank" style="color: inherit; text-decoration: none;">velog.io/@tlqhrm</a></span>
          </div>
        </div>
-->
          ...
          <div class="project-image">
            <div class="image-gallery">
              ...
              <div class="image-container">
                <img src="./images/tapplace1.png?t={{ site.time | date: "%s" }}" alt="TapPlace 간편결제 매장 찾기 서비스 메인 화면" class="clickable-image" data-index="0" />
                <img src="./images/tapplace2.png?t={{ site.time | date: "%s" }}" alt="TapPlace 위치 기반 매장 검색 결과 화면" class="clickable-image" data-index="1" />
                <img src="./images/tapplace3.png?t={{ site.time | date: "%s" }}" alt="TapPlace 매장 상세 정보 및 결제 방법 안내 화면" class="clickable-image" data-index="2" />
              </div>
...
<span style="background: rgba(41, 128, 185, 0.1); color: #2980b9; padding: 3px 8px; border-radius: 4px; font-size: 12px;">#고전게임</span>
          ...
          <div class="project-image">
            <div class="image-gallery">
              <!-- 이미지 갤러리 컨테이너 -->
              <div class="image-container">
                <img src="./images/yamegame1.png?t={{ site.time | date: "%s" }}" alt="야매게임 고전 콘솔게임 웹 에뮬레이터 메인 화면" class="clickable-image" data-index="0" />
              </div>
              <!-- 이미지가 여러 개일 때 표시되는 네비게이션 버튼들 -->
              <div class="gallery-nav" style="display: none;">
                <button class="gallery-btn prev-btn" type="button">
